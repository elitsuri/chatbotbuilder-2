"""
ChatbotBuilder - Backend API
No-code chatbot builder with NLP training and multi-channel deploy
"""
...
app = FastAPI(
    ...
    description="No-code chatbot builder with NLP training and multi-channel deploy",
    version="1.0.0",
)
...
@app.get("/health")
def health_check():
    return {"status": "healthy", "service": "ChatbotBuilder"}
